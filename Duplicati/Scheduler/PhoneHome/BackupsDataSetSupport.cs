...
namespace Duplicati.Scheduler.PhoneHome
{
    ...
    /// </remarks>
    public partial class BackupsDataSet
    {
        /// <summary>
        ...
        {
            BackupsDataSetTableAdapters.HistoryTableAdapter TableAdapter = new BackupsDataSetTableAdapters.HistoryTableAdapter();
        ...
        {
            BackupsDataSetTableAdapters.HistoryTableAdapter TableAdapter = new BackupsDataSetTableAdapters.HistoryTableAdapter();
            HistoryDataTable Table = TableAdapter.GetDataBy(aUserName, aMachineName, aEntryType.ToString(), aModificationDate);
            HistoryRow Row = null;
            if (Table.Count == 0)
