    ...
    public class SingleInstance : IDisposable
    {
        ...
        public SingleInstance(string basefolder)
        {
            ...
            else
            {
                ...
                using (System.IO.StreamWriter sw = new System.IO.StreamWriter(Platform.IsClientLinux ? UnixSupport.File.OpenExclusive(filename, System.IO.FileAccess.Write) : new System.IO.FileStream(filename, System.IO.FileMode.CreateNew, System.IO.FileAccess.Write, System.IO.FileShare.None)))
        ...
        private void m_filewatcher_Created(object sender, System.IO.FileSystemEventArgs e)
        {
            ...
            do
            {
                try
                {
                    ...
                    using (System.IO.StreamReader sr = new System.IO.StreamReader(Platform.IsClientLinux ? UnixSupport.File.OpenExclusive(e.FullPath, System.IO.FileAccess.ReadWrite) : new System.IO.FileStream(e.FullPath, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.None)))
