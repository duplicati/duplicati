Ext.define('Duplicati.ListUtility', {
	statics: {
		...
		formatSizeString: function(size) { return Duplicati.Utility.formatSizeString(size); },
		timeAgo: function(date) { return Duplicati.Utility.timeAgo(date); },
		...
		{	
			...
			if (metadata == '')
				metadata = '<span class="important-information">No backup information was found, <a title="Click here to run the backup now" href="#" onclick="Duplicati.service.runBackup(' + values.ID + ', false)">run a backup</a> to obtain data</span>'
