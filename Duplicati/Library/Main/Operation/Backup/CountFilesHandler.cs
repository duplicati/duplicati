...
namespace Duplicati.Library.Main.Operation.Backup
{
    ...
    {
        public static async Task Run(IEnumerable<string> sources, Snapshots.ISnapshotService snapshot, BackupResults result, Options options, IFilter sourcefilter, IFilter filter, Common.ITaskReader taskreader, CancellationToken token)
        {
