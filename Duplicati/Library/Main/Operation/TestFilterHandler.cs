...
namespace Duplicati.Library.Main.Operation
{
    internal class TestFilterHandler : IDisposable
    {
        ...
        public void Run(string[] sources, Library.Utility.IFilter filter)
        {
            ...
            {
                var source = Operation.Backup.FileEnumerationProcess.Run(snapshot, m_options.FileAttributeFilter, sourcefilter, filter, m_options.SymlinkPolicy, m_options.HardlinkPolicy, m_options.ExcludeEmptyFolders, null, m_result.TaskReader);
