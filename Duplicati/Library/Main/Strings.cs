...
namespace Duplicati.Library.Main.Strings 
{
    ...
    internal static class Options 
    {
        ...
        public static string DisablefilepathcacheShort { get { return LC.L(@"This option can be used to reduce the memory footprint by not keeping paths and scantimes in memory"); } }
