...
namespace Duplicati.Library.Main.Strings
{
    ...
    internal static class Options
    {
        ...
        public static string AllowpossiblyinvalidwindowspathsShort { get { return "Allows possibly invalid Windows paths (Windows only)"; } }
        public static string AllowpossiblyinvalidwindowspathsLong { get { return "Use this option to allow possibly invalid Windows paths to be considered for back up on Windows. This option may allow files with historically problematic paths (i.e., files or directories that end in a dot or a space) to be backed up, but may also trigger problems in Duplicati; e.g., this may generate errors that abort a backup, or may result in a \"successful\" backup where files with the problematic path have not actually been backed up."; } }
