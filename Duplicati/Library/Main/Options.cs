        ...
        public IList<Backend.ICommandLineArgument> SupportedCommands
        {
            get
            {
                return new List<Backend.ICommandLineArgument>(new Backend.ICommandLineArgument[] {
                    ...
                    new Backend.CommandLineArgument("full-if-older-than", Backend.CommandLineArgument.ArgumentType.Timespan, "The max duration between full backups", "If the last full backup is older than the duration supplied here"),
