...
Error message: {0}", error); }
                ...
                public static string WebserverForceIntermediateCertificatesDescription { get { return LC.L(@"Forces the webserver to send intermediate certificates in the SSL handshake. By default only certificates that are considered valid by the webserver will be emitted."); } }
