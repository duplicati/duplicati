...
namespace Duplicati.Library.Encryption.Strings {
    ...
    internal class AESEncryption {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Older versions of Duplicati used a non-standard encryption mode, which is no longer supported. Enable this flag to activate decryption support so you can restore backups made with old versions. This option has no effect if the backup files are made with Duplicati 1.2 or newer..
        /// </summary>
        internal static string AesencryptionallowfallbackdecryptionLong {
            get {
                return ResourceManager.GetString("AesencryptionallowfallbackdecryptionLong", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Use this option to enable the old decryption mode.
        /// </summary>
        internal static string AesencryptionallowfallbackdecryptionShort {
            get {
                return ResourceManager.GetString("AesencryptionallowfallbackdecryptionShort", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to AES decryption fallback is disabled by default, use the option {0} to change this instead.
        /// </summary>
        internal static string AesencryptionfallbackDeprecated {
            get {
                return ResourceManager.GetString("AesencryptionfallbackDeprecated", resourceCulture);
            }
        }
