...
namespace Duplicati.Library.Backend.Strings {
    ...
    internal static class SSHv2Backend {
        ...
        public static string DescriptionFingerprintLong { get { return LC.L(@"The server fingerprint used for validation of server identity. Format is eg. ""rsa 4096 11:22:33:44:55:66:77:88:99:00:11:22:33:44:55:66""."); } }
		...
		public static string FingerprintNotSpecifiedManagedError(string fingerprint, string hostkeyoption, string allkeysoptions) { return LC.L(@"Please add --{1}=""{0}"" to trust this host. Optionally you can use --{2} (NOT SECURE) for testing!", fingerprint); }   
    }
}
