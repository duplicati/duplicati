...
namespace Duplicati.Library.Backend.Strings {
    internal static class S3Backend {
        ...
        public static string S3NewStyleDescriptionLong { get { return LC.L(@"Specify this argument to make the S3 backend use subdomains rather than the previous url prefix method. See the S3 documentation for more details."); } }
