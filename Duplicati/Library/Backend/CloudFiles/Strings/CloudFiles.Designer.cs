...
namespace Duplicati.Library.Backend.Strings {
    ...
    internal class CloudFiles {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cloudfiles use different servers for authentification based on where the account was purchased, use this option to set an alternate authentication URL. This option overrides --{0}..
        /// </summary>
        internal static string DescriptionAuthenticationURLLong {
            get {
                return ResourceManager.GetString("DescriptionAuthenticationURLLong", resourceCulture);
            }
        }
