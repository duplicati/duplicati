...
namespace Duplicati.Library.Modules.Builtin.Strings {
    ...
    internal class SendMail {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This setting is required if mail should be sent, all other settings have default values. You can supply multiple email adresses seperated with commas, and you can use the normal adress format as specifed by RFC2822 section 3.4.
