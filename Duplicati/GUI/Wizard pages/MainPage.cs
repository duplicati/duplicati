...
namespace Duplicati.GUI.Wizard_pages
{
    public partial class MainPage : WizardControl
    {
        ...
        {
            Duplicati.Library.Core.UrlUtillity.OpenUrl("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal%40hexad%2edk&item_name=Duplicati%20Donation&no_shipping=2&no_note=1&tax=0&currency_code=EUR&lc=DK&bn=PP%2dDonationsBF&charset=UTF%2d8");
        }
