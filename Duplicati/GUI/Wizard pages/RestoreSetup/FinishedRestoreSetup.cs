        ...
        private void Restore(object sender, DoWorkEventArgs args)
        {
            ...
            using (Library.Utility.TempFolder tf = new Duplicati.Library.Utility.TempFolder())
            {
                ...
                if (System.IO.File.Exists(filename))
                {
                    ...
                    using (System.Data.IDbConnection scon = (System.Data.IDbConnection)Activator.CreateInstance(Library.Utility.SQLiteLoader.SQLiteConnectionType))
                    {
                        ...
                        Library.Utility.DatabaseUpgrader.UpgradeDatabase(scon, filename, typeof(Duplicati.Datamodel.Schedule));
                    }
                    ...
                    Program.DataConnection.Provider.Connection = (System.Data.IDbConnection)Activator.CreateInstance(Library.Utility.SQLiteLoader.SQLiteConnectionType);
