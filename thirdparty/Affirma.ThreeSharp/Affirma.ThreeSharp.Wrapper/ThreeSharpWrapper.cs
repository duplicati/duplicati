...
/* Kenneth Skovhede, opensource@hexad.dk:
 * 20-01-2009 made class inheritable
 */
...
namespace Affirma.ThreeSharp.Wrapper
{
    ...
    {
        protected ThreeSharpConfig config;
        protected IThreeSharp service;

        protected ThreeSharpWrapper()
        { 
        }
        ...
        /// </summary>
        public virtual void AddBucket(String bucketName)
        {
        ...
        /// </summary>
        public virtual String ListBucket(String bucketName)
        {
        ...
        /// </summary>
        public virtual void AddStringObject(String bucketName, String keyName, String data)
        {
        ...
        /// </summary>
        public virtual void AddFileObject(String bucketName, String keyName, String localfile)
        {
            using (ObjectAddRequest objectAddRequest = new ObjectAddRequest(bucketName, keyName))
            {
        ...
        /// </summary>
        public virtual void AddEncryptFileObject(String bucketName, String keyName, String localfile, String encryptionKey, String encryptionIV)
        {
            using (ObjectAddRequest objectAddRequest = new ObjectAddRequest(bucketName, keyName))
            {
                objectAddRequest.LoadStreamWithFile(localfile);
        ...
        /// </summary>
        public virtual String GetStringObject(String bucketName, String keyName)
        {
        ...
        /// </summary>
        public virtual void GetFileObject(String bucketName, String keyName, String localfile)
        {
            using (ObjectGetRequest objectGetRequest = new ObjectGetRequest(bucketName, keyName))
            using (ObjectGetResponse objectGetResponse = this.service.ObjectGet(objectGetRequest))
            {
        ...
        /// </summary>
        public virtual void GetDecryptFileObject(String bucketName, String keyName, String localfile, String encryptionKey, String encryptionIV)
        {
            using (ObjectGetRequest objectGetRequest = new ObjectGetRequest(bucketName, keyName))
            using (ObjectGetResponse objectGetResponse = this.service.ObjectGet(objectGetRequest))
            {
        ...
        /// </summary>
        public virtual void CopyObject(String sourceBucketName, String sourceKey, String destinationBucketName, String destinationKey)
        {
        ...
        /// </summary>
        public virtual String GetUrl(String bucketName, String keyName)
        {
        ...
        /// </summary>
        public virtual void DeleteObject(String bucketName, String keyName)
        {
