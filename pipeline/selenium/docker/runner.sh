...
sudo -E dotnet publish -o /home/seluser/published/ /sources/Duplicati.sln

export DUPLICATI_WEBSERVER_LOGGING=1
sudo -E /home/seluser/published/Duplicati.Server --webservice-password=easy1234 &
