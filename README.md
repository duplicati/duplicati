...
&nbsp;&nbsp; *Amazon Cloud Drive and S3, Backblaze (B2), Box, Dropibox, FTP, Google Cloud and Drive, HubiC, MEGA, Microsoft Azure and OneDrive, Rackspace Cloud Files, Sia, OpenStack Storage (Swift), SSH (SFTP), WebDAV, [and more!](https://duplicati.readthedocs.io/en/latest/01-introduction/#supported-backends)*
