...
&nbsp;&nbsp; *Amazon Cloud Drive, Amazon S3, Backblaze (B2), Box, Dropibox, FTP, Google Cloud, Google Drive, HubiC, MEGA, Microsoft Azure, Microsoft OneDrive, Rackspace Cloud Files, Sia, OpenStack Storage (Swift), SSH (SFTP), WebDAV, [and more!](https://duplicati.readthedocs.io/en/latest/01-introduction/#supported-backends)*
