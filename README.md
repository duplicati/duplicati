...
&nbsp;&nbsp; *Amazon Cloud Drive (AmzCD), Amazon S3, Azure, Backblaze (B2), Box, Dropibox, FTP, Google Cloud, Google Drive, HubiC, MEGA, OneDrive, Rackspace Cloud Files, Sia, Swift / OpenStack, SSH (SFTP), WebDAV, and more!*
